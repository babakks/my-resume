...
{\textsc{Mashhad, IRAN}} {
    ...
    {
        \bodytexttitle{JavaScript, Redis, PM2}
        \bodytext{At the \textit{Public Services} development team; put effort to
            reduce deployment costs via containerization and running with zero
            external setup. Adding detailed functional tests to make debugging
            more convenient was another goal that was achieved.
        }
    }
...
\headedsection{Authored VS Code Extensions}
{} {
    \headedsubsection
